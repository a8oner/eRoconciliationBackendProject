...
namespace DataAccsess.Concrete.EntityFramework.Context
{
    public class ContextDb : DbContext
    {
        ...
        {
            //optionsBuilder.UseSqlServer(@"Server=aOner\db;Database=eReconciliationDbdeneme;Integrated Security=true");
			optionsBuilder.UseNpgsql("Host=localhost;Port=5432; Database=eReconciliationDbdeneme; UserName=postgres ; Password=1234");
