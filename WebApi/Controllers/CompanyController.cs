...
namespace WebApi.Controllers
{
    ...
    public class CompanyController : Controller
    {
        ...
        public IActionResult GetCompanyList()
        {
            ...
            if(result.Success)
            {
                return Ok(result);//200 300 400(exception(bu işlem başarısız oldu)) 500 404(not found) 403(işlemi yapmaya yetkin yok)
			}
        ...
        [HttpPost("addCompanyAndUserCompany")]//data ekleme işlemi.kullanıcının ekstradan şirket eklemesi için
